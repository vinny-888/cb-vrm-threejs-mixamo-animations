...
// VRM 1
const modelUrl = 'https://m.cyberbrokers.com/eth/mech/81/files/mech_2k.vrm';
const animationUrl = './animations/Warming Up.fbx'; // MixamoのアニメーションのURL
...
loadVRM( modelUrl ).then( ( vrm ) => { // vrmを読み込む
  ...
  camera.position.set( 1, head.getWorldPosition( new THREE.Vector3() ).y, 8.0 ); // カメラを頭が中心に来るように動かす
